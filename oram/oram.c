...
{  
    ...
    __obliv_c__genOblivInt(y, 0);
    // obliv int res = 0;
    __obliv_c__int res = __obliv_c__newInt();
    __obliv_c__genOblivInt(res, 0);
    __obliv_c__int tmp1 = __obliv_c__newInt();
    __obliv_c__genOblivInt(tmp1, 0);
    __obliv_c__intCondAssign(cond, res, tmp1);
    // y = x >> 16;
    ...
    // obliv if (y != 0) { n = n - 8; x = y; }
        ...
        // {
            ...
            __obliv_c__genOblivInt(tmp11, 0);
    ...
    __obliv_c__genOblivInt(tmp12, 0);
    ...
    // obliv if (y != 0) { n = n - 4; x = y; }
        ...
        __obliv_c__genOblivBool(tmp14, false);
        ...
        // {
            ...
            __obliv_c__genOblivInt(tmp16, 0);
    ...
    __obliv_c__genOblivInt(tmp17, 0);
    ...
    // obliv if (y != 0) { n = n - 2; x = y; }
        ...
        __obliv_c__genOblivBool(tmp19, false);
        ...
        // {
            ...
            __obliv_c__genOblivInt(tmp21, 0);
    ...
    __obliv_c__genOblivInt(tmp22, 0);
    ...
    // obliv if (y != 0) {
        ...
        __obliv_c__genOblivInt(tmp26, 0);
    ...
    // else {
        ...
        __obliv_c__genOblivInt(tmp27, 0);
